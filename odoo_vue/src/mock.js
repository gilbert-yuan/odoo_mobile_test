...
// let gridData = [{'gridCols': 4, 'groupTitle': '\u4eba\u529b\u8d44\u6e90', 'gridRow': [{'image': '', 'actionId': 3, 'title': '\u8d39\u7528'}], 'sequence': 2}]
// // Mock.mock( url, post/get , 返回的数据)；
// Mock.mock('/odoo/mobile/get/all/grid_data', 'get', gridData)
...
// }
// // Mock.mock( url, post/get , 返回的数据)；
// Mock.mock('/odoo/mobile/get/action/views', 'get', getActionView)
...
// }
// // Mock.mock( url, post/get , 返回的数据)；
// Mock.mock('/odoo/mobile/get/tree', 'get', getTreeView)
...
// // }
// // // Mock.mock( url, post/get , 返回的数据)；
// // Mock.mock('/odoo/mobile/form/view/data', 'get', getFromViewData)
...
// }
// // Mock.mock( url, post/get , 返回的数据)；
// Mock.mock('/odoo/mobile/get/formPreView', 'get', getPreViewFromData)
...
// Mock.mock('/odoo/mobile/form/new/data', 'get', getViewFromData)
...
// Mock.mock('/odoo/mobile/model/name_search', 'get', getViewNameSearchData)
